...
logging.basicConfig(filename="abnormal_logfile_s4_TL_test.log", filemode="w", format=Log_Format, level=logging.DEBUG)
...
cfg.load_from = './work_dirs/tsn_moblieone_s4_1x1x8_20e_Dassult/best_acc_top1_epoch_120.pth'
...
checkpoint = './work_dirs/tsn_moblieone_s4_1x1x8_20e_Dassult/best_acc_top1_epoch_120.pth'
