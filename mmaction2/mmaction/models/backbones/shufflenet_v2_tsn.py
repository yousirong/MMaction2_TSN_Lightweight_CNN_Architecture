...
# from mmaction.models import MODELS, BaseRecognizer


class InvertedResidual(BaseModule):
    """InvertedResidual block for ShuffleNetV2TSN backbone.
    ...
    def forward(self, x):
        ...
        def _inner_forward(x):
            if self.stride > 1:
                ...
                # ShuffleNetV2TSN model by using mmdeploy.
                channels = x.shape[1]
...
class ShuffleNetV2TSN(BaseBackbone):
    """ShuffleNetV2TSN backbone.
    ...
    def __init__(self,
                 ...
                 with_cp=False,
                 init_cfg=None):
        super(ShuffleNetV2TSN, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(ShuffleNetV2TSN, self).init_weights()
    ...
    def train(self, mode=True):
        super(ShuffleNetV2TSN, self).train(mode)
        self._freeze_stages()
