...
logging.basicConfig(filename="abnormal_logfile_resnet_aihub_TL_test.log", filemode="w", format=Log_Format, level=logging.DEBUG)
logger = logging.getLogger()

cfg = Config.fromfile('./configs/recognition/tsn/juneyong_backbones/tsn_r50_1x1x8_20e_Dassult_aihub.py')
...
cfg.load_from = './work_dirs/tsn_r50_1x1x8_20e_Dassult_aihub/best_acc_top1_epoch_8.pth'
cfg.work_dir = './work_dirs/tsn_r50_1x1x8_20e_Dassult_aihub/'
...
checkpoint = './work_dirs/tsn_r50_1x1x8_20e_Dassult_aihub/best_acc_top1_epoch_8.pth'
