...
if __name__ == '__main__':
    ...
    f = open("abnormal_logfile_YT_mobileone_s0.log", "rt")  # 유튜브 실제 데이터 log
    # f = open("abnormal_logfile_s0_TL_test.log", "rt") # TL 테스트 데이터 log
    lines = f.readlines()
    for line in lines:
        print(line, end='')
        line_arr = line.split("\t")
    ...
    print("F2-Score", metrics.f1_score(y_true, y_pred, average="weighted", labels=label_list))