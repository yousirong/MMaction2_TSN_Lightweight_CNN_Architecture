...
logging.basicConfig(filename="abnormal_logfile_TL_mobilenet_v3_small.log", filemode="w", format=Log_Format, level=logging.DEBUG)
...
cfg.load_from = './work_dirs/tsn_mobilenet_v3_small_1x1x8_20e_Dassult/best_acc_top1_epoch_120.pth'
...
checkpoint = './work_dirs/tsn_mobilenet_v3_small_1x1x8_20e_Dassult/best_acc_top1_epoch_120.pth'
