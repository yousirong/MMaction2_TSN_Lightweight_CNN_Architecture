...
logging.basicConfig(filename="abnormal_logfile_TL_shufflenet_v2.log", filemode="w", format=Log_Format, level=logging.DEBUG)
logger = logging.getLogger()

cfg = Config.fromfile('./configs/recognition/tsn/juneyong_backbones/tsn_shufflenet_v2_1x1x8_20e_Dassult.py')
