...
logging.basicConfig(filename="abnormal_logfile_YT_mobileone_s2.log", filemode="w", format=Log_Format, level=logging.DEBUG)
...
cfg.load_from = './work_dirs/tsn_moblieone_s2_1x1x8_20e_Dassult/best_acc_top1_epoch_104.pth'
...
checkpoint = './work_dirs/tsn_moblieone_s2_1x1x8_20e_Dassult/best_acc_top1_epoch_104.pth'
