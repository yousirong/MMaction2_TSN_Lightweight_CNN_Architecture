...
logging.basicConfig(filename="abnormal_logfile_YT_mobilenet_v3_large.log", filemode="w", format=Log_Format, level=logging.DEBUG)
logger = logging.getLogger()

cfg = Config.fromfile('./configs/recognition/tsn/juneyong_backbones/tsn_mobilenet_v3_large_1x1x8_20e_Dassult.py')
...
cfg.load_from = './work_dirs/tsn_mobilenet_v3_large_1x1x8_20e_Dassult/best_acc_top1_epoch_118.pth'
cfg.work_dir = './work_dirs/tsn_mobilenet_v3_large_1x1x8_20e_Dassult/'
...
checkpoint = './work_dirs/tsn_mobilenet_v3_large_1x1x8_20e_Dassult/best_acc_top1_epoch_118.pth'
