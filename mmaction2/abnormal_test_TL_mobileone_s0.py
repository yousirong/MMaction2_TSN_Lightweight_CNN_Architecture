...
logging.basicConfig(filename="abnormal_logfile_TL_mobileone_s0.log", filemode="w", format=Log_Format, level=logging.DEBUG)
...
cfg.load_from = './work_dirs/tsn_moblieone_s0_1x1x8_20e_Dassult/best_acc_top1_epoch_112.pth'
...
checkpoint = './work_dirs/tsn_moblieone_s0_1x1x8_20e_Dassult/best_acc_top1_epoch_112.pth'
