...
logging.basicConfig(filename="abnormal_logfile_TL_efficientnet_b0.log", filemode="w", format=Log_Format, level=logging.DEBUG)
logger = logging.getLogger()

cfg = Config.fromfile('./configs/recognition/tsn/juneyong_backbones/tsn_efficientnet_b0_1x1x8_20e_Dassult.py')
...
cfg.load_from = './work_dirs/tsn_efficientnet_b0_1x1x8_20e_Dassult/best_acc_top1_epoch_113.pth'
cfg.work_dir = './work_dirs/tsn_efficientnet_b0_1x1x8_20e_Dassult/'
...
checkpoint = './work_dirs/tsn_efficientnet_b0_1x1x8_20e_Dassult/best_acc_top1_epoch_113.pth'
